      ...
      {showPayrollModal && (
          ...
          >
            ...
            <div className="text-center">
              ...
              <div className="border rounded-xl p-4 mb-4">
                <div className="flex justify-between text-sm text-gray-600">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">3 Pending Payments</p>
                  </div>
              ...
              <div className="text-xs text-red-500 bg-red-50 rounded-lg px-4 py-2 mb-4 border border-red-100">
                This action will mark all pending payrolls as complete and cannot be undone.
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-xl w-full max-w-xs p-6 relative text-center shadow-xl">
            ...
            <h2 className="text-lg font-semibold text-gray-900 mb-1">₹ Process Payroll</h2>
            <p className="text-sm text-gray-500 mb-4">
              You’re about to process payroll for all pending payment
            </p>
            ...
            <h3 className="font-semibold text-gray-800 mb-1">Payment Successful!</h3>
            <p className="text-sm text-gray-500">Payroll has been processed for 3 employees.</p>
          </div>
        </div>
      )}
              ...
              >
                ...
                <div className="flex justify-between items-start border-b pb-3 mb-3">
                  ...
                  <button
                   ...
                   className="px-2.5 py-0.5 text-xs border rounded-full text-indigo-600 border-indigo-300 hover:bg-indigo-50">
                    {emp.status}
                  </button>
                </div>
                ...
                <div className="flex justify-between gap-2 mt-8">
                  ...
                  <button className="flex items-center gap-1 text-indigo-600 border border-indigo-300 px-3 py-1.5 rounded hover:bg-indigo-50 text-xs">
    ...
    >
      ...
      <div className="text-sm text-gray-700 font-sans">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs mb-4">
          <div>
            <p><b>Employee Name:</b> {selectedEmployee.name}</p>
            <p><b>Employee ID:</b> EMP00{selectedEmployee.id}</p>
            <p><b>Department:</b> Engineering</p>
            <p><b>Position:</b> {selectedEmployee.title}</p>
          </div>
          <div className="text-right">
            <p><b>Payment Status:</b> {selectedEmployee.status}</p>
            <p><b>Payment Date:</b> Pending</p>
            <p><b>Bank Account:</b> HDFC-XXXX4513</p>
            <p><b>PAN:</b> ABCPK1234X</p>
          </div>
        </div>

        {/* ATTENDANCE */}
        <div className="grid grid-cols-4 gap-2 mb-5 text-center text-xs font-medium">
          <div className="bg-green-100 text-green-800 rounded p-1.5">Present<br />{selectedEmployee.attendance.P} days</div>
          <div className="bg-red-100 text-red-700 rounded p-1.5">Absent<br />{selectedEmployee.attendance.A} days</div>
          <div className="bg-blue-100 text-blue-700 rounded p-1.5">On Leave<br />{selectedEmployee.attendance.L} days</div>
          <div className="bg-gray-100 text-gray-700 rounded p-1.5">Holidays<br />7 days</div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <div>
            ...
            <ul className="space-y-1 text-xs">
              <li className="flex justify-between"><span>Basic Salary</span><span>{selectedEmployee.salary}</span></li>
              <li className="flex justify-between"><span>House Rent Allowance</span><span>₹8,000</span></li>
              <li className="flex justify-between"><span>Vehicle Petrol</span><span>₹1,000</span></li>
              <li className="flex justify-between"><span>Medical Allowance</span><span>₹1,250</span></li>
              <li className="flex justify-between font-semibold pt-2 border-t"><span>Gross Salary</span><span>₹19,000</span></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-2 text-sm">Deductions</h3>
            <ul className="space-y-1 text-xs">
              <li className="flex justify-between"><span>Professional Tax</span><span>₹200</span></li>
              <li className="flex justify-between"><span>TDS</span><span>₹700</span></li>
              <li className="flex justify-between"><span>Provident Fund</span><span>₹1,800</span></li>
              <li className="flex justify-between"><span>Attendance Deduction</span><span>₹1600</span></li>
              <li className="flex justify-between font-semibold pt-2 border-t"><span>Total Deductions</span><span>₹3,380</span></li>
            </ul>
          </div>
        </div>
        ...
        <p className="text-[11px] text-gray-500 mb-4">
          Amount in words: Fifteen Thousand Three Hundred Twenty rupees only
        </p>

        {/* BUTTONS */}
        <div className="flex justify-between gap-3 mt-4">
          <button className="flex items-center gap-1 px-4 py-2 border border-gray-300 rounded text-gray-700 text-sm hover:bg-gray-50">
            Print
          </button>
          <button className="flex items-center gap-1 px-4 py-2 border border-indigo-300 text-indigo-600 rounded text-sm hover:bg-indigo-50">
            Download PDF
          </button>
        </div>
      </div>
